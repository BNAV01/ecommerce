...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleNotFound(StockNotFoundException exception, HttpServletRequest request) {
    ...
    public ResponseEntity<ProblemDetail> handleOperation(StockOperationException exception, HttpServletRequest request) {
        String correlationId = CorrelationId.ensure(request.getHeader(CorrelationId.HEADER));
        ProblemDetail detail = ProblemDetailsFactory.of(
                HttpStatus.CONFLICT,
