    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/inventory/adjustments").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/inventory/reservations/**").hasAnyRole("ADMIN", "CUSTOMER")
